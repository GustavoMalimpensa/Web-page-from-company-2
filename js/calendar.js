 ...
 */
 ...
 (function($) {
     ...
     var defaults = {
         ...
         time_end:           '22:00',
         time_split:         '30',
         // Origem dos dados dos eventos. Pode ser um dos seguintes:
         // - URL para retornar a lista JSON de eventos em formato especial.
         // {success:1, result: [....]} ou para o erro {success:0, error:'Algo terrível aconteceu'}
         // eventos: [...] conforme descrito na descrição da propriedade de eventos
         // As variáveis ​​de início e fim serão enviadas para esta url
         // - Uma função que recebeu a data inicial e final, e que
         // retorna um array de eventos (conforme descrito na descrição da propriedade de eventos)
         // - Um array contendo os eventos
         events_source:      '',
